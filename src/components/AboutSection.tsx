...
const Social3DIcons = () => {
  const links = [
    { name: 'GitHub', icon: <Github size={24} />, url: 'https://github.com/kunalyadav1284', color: 'shadow-[0_0_20px_rgba(255,255,255,0.4)]', hoverBorder: 'hover:border-white' },
    { name: 'LinkedIn', icon: <Linkedin size={24} />, url: 'https://www.linkedin.com/in/kunal-yadav-403676379/', color: 'shadow-[0_0_20px_rgba(0,119,181,0.6)]', hoverBorder: 'hover:border-[#0077b5]' },
    ...
    { name: 'Gmail', icon: <Mail size={24} />, url: 'mailto:kunalyadav9992462520@gmail.com', color: 'shadow-[0_0_20px_rgba(234,67,53,0.6)]', hoverBorder: 'hover:border-[#ea4335]' },
            ...
            >
              ...
              <ul className="space-y-4 font-mono text-sm tracking-widest text-slate-400">
                <li className="flex items-center gap-4">
                  ...
                  <span className="text-white">Kunal Yadav</span>
                </li>
                <li className="flex items-center gap-4">
